...
def scrape_kabum_category(category: str, max_products: int = 500):
    ...
    base_url_or_list = CATEGORY_URLS['kabum'][category]
    urls = [base_url_or_list] if isinstance(base_url_or_list, str) else base_url_or_list
    ...
    for base_url in urls:
        ...
        page = 1
        print(f"Scraping Kabum {category} - URL: {base_url}")
        ...
        try:
            ...
            print(f"Error scraping Kabum category {category} ({base_url}): {e}")
            continue
